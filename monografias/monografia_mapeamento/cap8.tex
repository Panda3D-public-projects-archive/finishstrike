...
\subsection{Python}
Python é um linguagem orientada a objetos de tipagem dinâmica, onde os tipos dos dados são atribuídos durante a interpretação do código dinamicamente. O Python tem foco na produtividade com uma sitaxe legível e simples, bem como módulos auxiliares (grande maioria OpenSource) que garatem um excelente desempenho.
...
\centering
\begin{center}
    \includegraphics[scale=0.15,bb=0 0 1280 750]{imagens/fotos/blender.png}
\end{center}
\caption{Tela inicial do Blender.}
\label{fig:blender}
\end{figure}

O Blender é um produto da Blender Fundation, conforme pode ser visto na imagem \ref{fig:blender}, que é open source e desenvolvido em Python para modelagem de objetos 3D que está disponível para vários sistemas operacionais sobre a licença GNU (\textit{General Public License}).
...
\centering
\begin{center}
    \includegraphics[scale=0.2,bb=0 0 808 628]{imagens/fotos/battle_robots.png}
\end{center}
...
O agente utilizado foi inspirado no personagem de um filme que também é um agente inteligente, é possível notar a semelhança na figura \ref{fig:agente1}.

\begin{figure}[!htb]
\centering
\begin{center}
    \includegraphics[scale=0.2,bb=0 0 700 560]{imagens/fotos/robot.png}
\end{center}
\caption{O agente utilizado nos testes. Modelado em \textit{Blender3D}.}
\label{fig:agente1}
\end{figure}
...
\caption{O ambiente utilizado para a prova de conceito. Modelada em Blender3D.}
...
\begin{figure}[htb]
\centering
\includegraphics[scale=0.2,bb=0 0 830 560]{imagens/fotos/colisions.png}
