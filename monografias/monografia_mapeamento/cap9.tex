...
Ao termino do SLAM e da aplicação que foi sua prova de conceito, uma outra aplicação foi desenvolvida utilizando a parte de mapeamento em conjunto com a parte de visão do Tool Kit  Horus, comprovando assim a interoperabilidade entre os módulos.
