...
%Instancia do contador que será usado como referência na monografia
\newcounter{mypage}
...
\include{folharosto}
\stepcounter{mypage}
%Include da folha de aprovações
\include{folhaaprovacao}
\stepcounter{mypage}
%Include da dedicatória
\include{dedicatoria}
\stepcounter{mypage}
...
% e depois incremento...
\setcounter{mypage}{\value{p.styage}}
\clearpage
