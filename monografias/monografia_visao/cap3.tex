...
dispositivos emissores de lasers é mostrado na Figura \ref{fig:robo}.
...
Inicialmente, o agente é configurado com os comportamentos de Navegação, Mapeamento, Localização e Leitura de placas. Após a configuração, o agente é inserido em um ambiente totalmente desconhecido com a missão de chegar a uma sala específica. Na Figura \ref{fig:ambienteEplaca} é apresentado a vista de cima do ambiente utilizado no Ariadnes.
...
\centering
\begin{center}
    \includegraphics[scale=0.2, bb = 0 0 761 408]{imagens/placa.png}
\end{center}
