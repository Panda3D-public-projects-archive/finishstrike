...
\end{center}
    ...
    A linha de pesquisa denominada Processamento de Imagem consiste em realizar operações sobre uma imagem. Essas operações normalmente sao determinadas por funçoes, cujo dominio é a imagem a ser processada e o contra-domínio é o espaço das funções. Uma operaçao comum a ser aplicada em imagens é a filtragem.
