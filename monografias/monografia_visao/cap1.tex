...
O sistema nervoso é formado por um conjunto extremamente complexo de neurônios. Os neurônios estão conectados uns aos outros através de sinapses. Nos neurônios a comunicação é realizada através de impulsos elétricos, quando um impulso é recebido, o neurônio o processa, e passado um limite de ação, dispara um segundo impulso o qual flui do corpo celular para o axônio que, por sua vez, pode ou não estar conectado a um dendrito de outra célula. A Figura 0000 apresenta uma representação de um neurônio.

\begin{figure}[!htb]
\centering
\begin{center}
    \includegraphics[scale=0.2, bb= 0 0 751 469]{imagens/neuronioBio.PNG}
\end{center}
...
\centering
\begin{center}
    \includegraphics[scale=0.2, bb= 0 0 349 264]{imagens/mcculloch.PNG}
\end{center}
...
\centering
\begin{center}
    \includegraphics[scale=0.2, bb= 0 0 559 310]{imagens/funcaoAtivacao.PNG}
\end{center}
...
\centering
\begin{center}
  \includegraphics[scale=0.2, bb= 0 0 559 310]{imagens/graficoFuncaoLimiar.PNG}
\end{center}
...
\centering
\begin{center}
 \includegraphics[scale=0.2, bb= 0 0 280 208]{imagens/graficoFuncaoSigmoide.PNG}
\end{center}
...
\centering
\begin{center}
 \includegraphics[scale=0.2, bb= 0 0 559 310]{imagens/graficoFuncaoSignun.PNG}
\end{center}
...
\centering
\begin{center}
\includegraphics[scale=0.2, bb= 0 0 559 310]{imagens/graficoHiperbolica.PNG}
\end{center}
...
\centering
\begin{center}
    \includegraphics[scale=0.1, bb= 0 0 559 310]{imagens/redeUmaCamada.PNG}
\end{center}
...
\centering
\begin{center}
    \includegraphics[scale=0.2, bb= 0 0 559 310]{imagens/redeMultiplaCamada.PNG}
\end{center}
...
\centering
\begin{center}
    \includegraphics[scale=0.2, bb= 0 0 559 310]{imagens/feedBack.PNG}
\end{center}
...
\centering
\begin{center}
    \includegraphics[scale=0.2, bb= 0 0 559 310]{imagens/aprendizadoSuper.PNG}
\end{center}
...
\centering
\begin{center}
    \includegraphics[scale=0.2, bb= 0 0 559 10]{imagens/aprendizadoNSuper.PNG}
\end{center}
