...
\item Junções: consiste em um ponto que possui pelo menos três pixels pretos na 8-vizinhança. No presente trabalho, considerou-se apenas dois tipos de junções: com três e quatro vizinhos. A Figura 000000 mostra um exemplo de cada caso.

\item \textit{Loops}: esta é a característica estrutural mais complexa de ser extraída em um caractere. Neste trabalho, o processo de contagem de \textit{loops} trabalha com a imagem negativa do caractere (Figura 00000), ou seja, o fundo da imagem é representado pela cor preta, enquanto que o caractere é representado pela cor branca. O número de loops pode ser calculado como o número de grupos de pixels pretos na imagem negativa, representado na Figura 00000 pelos números 1, 2, 3, subtraido de um. Essa subrtação é feita para desconsiderar o fundo da imagem como um \textit{loop}.
\end{itemize} 
